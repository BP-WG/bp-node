...
Register-ArgumentCompleter -Native -CommandName 'bp-node' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'bp-node' {
            ...
            [CompletionResult]::new('-p', '-p', [CompletionResultType]::ParameterName, 'Address(es) to listen for block provider connections')
            [CompletionResult]::new('--provider', '--provider', [CompletionResultType]::ParameterName, 'Address(es) to listen for block provider connections')
